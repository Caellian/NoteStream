...
class ActivitySettings : AppCompatPreferenceActivity() {
    ...
    override fun isValidFragment(fragmentName: String): Boolean {
        return (PreferenceFragment::class.java.name == fragmentName
                ...
                || StoragePreferenceFragment::class.java.name == fragmentName
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    class StoragePreferenceFragment : PreferenceFragment() {
        override fun onCreate(savedInstanceState: Bundle?) {
            super.onCreate(savedInstanceState)
        ...
        private val sBindPreferenceSummaryToValueListener = Preference.OnPreferenceChangeListener { preference, value ->
            ...
            if (preference is ListPreference) {
                ...
                if (TextUtils.isEmpty(stringValue)) {
                    //                    preference.setSummary(R.string.pref_ringtone_silent); TODO: Like this
