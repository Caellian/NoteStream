...
public class ObjectGroupRepeated extends AbstractMP3Object {
    ...
    public int getSize() {
        ...
        for (Object anObjectList : this.objectList) {
            object = (AbstractMP3Object) anObjectList;
            size += object.getSize();
        }
        return size;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!this.objectList.equals(objectGroupRepeated.objectList)) {
            return false;
        }
        return this.propertyList.equals(objectGroupRepeated.propertyList) && super.equals(obj);
    }
