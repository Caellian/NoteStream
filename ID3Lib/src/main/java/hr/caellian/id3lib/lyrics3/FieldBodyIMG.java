...
import hr.caellian.id3lib.object.ObjectLyrics3Image;
...
public class FieldBodyIMG extends AbstractLyrics3v2FieldBody {
    ...
    public boolean isSubsetOf(final Object object) {
        if (!(object instanceof FieldBodyIMG)) {
            return false;
        }
    ...
    public boolean equals(final Object obj) {
        ...
        return this.images.equals(fieldBodyIMG.images) && super.equals(obj);
    }
...
//        throw new UnsupportedOperationException();
    ...
    /**
     * @param imageString string containing image data.
     */
