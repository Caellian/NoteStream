...
import hr.caellian.id3lib.object.AbstractMP3Object;
...
public abstract class AbstractMP3FragmentBody extends AbstractMP3FileItem {
     ...
     */
    private List<AbstractMP3Object> objectList = new ArrayList<>(AbstractMP3FragmentBody.SIZE_OBJECT_LIST);
    ...
    public String getBriefDescription() {
        final StringBuilder stringBuffer = new StringBuilder(AbstractMP3FragmentBody.SIZE_BRIEF_DESCRIPTION);
        for (AbstractMP3Object object : objectList) {
    ...
    public String getDescription() {
        final StringBuilder stringBuffer = new StringBuilder(AbstractMP3FragmentBody.SIZE_DESCRIPTION);
        for (AbstractMP3Object object : objectList) {
            final String identifier = object.getIdentifier();
            stringBuffer.append(identifier);
            stringBuffer.append(" = ");
    ...
    public void setObject(final String identifier, final Object object) {
        for (AbstractMP3Object abstractMP3Object : objectList) {
    ...
    public boolean isSubsetOf(final Object object) {
        ...
        for (int i = 0; i < objectListSize; i++) {
            final AbstractMP3Object abstractMP3Object = objectList.get(i);
    ...
    public boolean equals(final Object obj) {
        ...
        return objectList.equals(abstractMP3FragmentBody.objectList) && super.equals(obj);
    }
