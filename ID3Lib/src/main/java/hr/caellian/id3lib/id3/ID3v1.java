...
import hr.caellian.id3lib.TagNotFoundException;
import hr.caellian.id3lib.TagOptionSingleton;
...
public class ID3v1 extends AbstractID3v1 {
    ...
    public ID3v1(final AbstractMP3Tag mp3tag) {
        if (mp3tag != null) {
            ...
            this.album = convertedTag.album.trim();
            this.artist = convertedTag.artist.trim();
            this.comment = convertedTag.comment.trim();
            this.title = convertedTag.title.trim();
            this.year = convertedTag.year.trim();
    ...
    public void append(final AbstractMP3Tag tag) {
        ...
        if (tag != null) {
            ...
            if (tag instanceof hr.caellian.id3lib.lyrics3.AbstractLyrics3) {
    ...
    public boolean equals(final Object obj) {
        ...
        return this.year.equals(id3v1.year) && super.equals(obj);
    }
