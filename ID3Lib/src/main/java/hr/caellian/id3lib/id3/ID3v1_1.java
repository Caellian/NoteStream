...
public class ID3v1_1 extends ID3v1 {
    ...
    public ID3v1_1(final AbstractMP3Tag mp3tag) {
        if (mp3tag != null) {
            if (mp3tag instanceof ID3v1) {
                ...
                this.title = id3old.title.trim();
                this.artist = id3old.artist.trim();
                this.album = id3old.album.trim();
                this.comment = id3old.comment.trim();
                this.year = id3old.year.trim();
    ...
    public boolean equals(final Object obj) {
        ...
        return this.track == id3v1_1.track && super.equals(obj);
    }
