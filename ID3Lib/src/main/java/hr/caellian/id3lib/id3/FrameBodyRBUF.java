...
import hr.caellian.id3lib.object.ObjectBooleanByte;
...
public class FrameBodyRBUF extends AbstractID3v2FrameBody {
    ...
    public FrameBodyRBUF(final byte bufferSize, final boolean embeddedInfoFlag, final byte offsetToNextTag) {
        setObject("Buffer Size", bufferSize);
        setObject("Embedded Info Flag", embeddedInfoFlag);
        setObject("Offset to Next Flag", offsetToNextTag);
    }
