...
public abstract class AbstractID3v2 extends AbstractID3 {
    ...
    private Map<String, AbstractID3v2Frame> frameMap = null;
    ...
    public Iterator<AbstractID3v2Frame> getFrameOfType(final String identifier) {
        final Iterator<String> iterator = frameMap.keySet().iterator();
        final Set<AbstractID3v2Frame> result = new HashSet<>(frameMap.size());
        String hashSetKey;
        while (iterator.hasNext()) {
            hashSetKey = iterator.next();
    ...
    public boolean equals(final Object obj) {
        ...
        return frameMap.equals(abstractID3v2.frameMap) && super.equals(obj);
    }
