...
import hr.caellian.id3lib.object.ObjectNumberFixedLength;
...
public class FrameBodyRVRB extends AbstractID3v2FrameBody {
    ...
    public FrameBodyRVRB(final short reverbLeft,
        ...
        setObject("Reverb Left", reverbLeft);
        setObject("Reverb Right", reverbRight);
        setObject("Reverb Bounces Left", reverbBouncesLeft);
        setObject("Reverb Bounces Right", reverbBouncesRight);
        setObject("Reverb Feedback Left To Left", reverbFeedbackLeftToLeft);
        setObject("Reverb Feedback Left To Right", reverbFeedbackLeftToRight);
        setObject("Reverb Feedback Right To Right", reverbFeedbackRightToRight);
        setObject("Reverb Feedback Right to Left", reverbFeedbackRightToLeft);
        setObject("Premix Left To Right", premixLeftToRight);
        setObject("Premix Right To Left", premixRightToLeft);
    }
