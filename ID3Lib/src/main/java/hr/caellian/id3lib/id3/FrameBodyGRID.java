...
import hr.caellian.id3lib.object.ObjectByteArraySizeTerminated;
import hr.caellian.id3lib.object.ObjectNumberFixedLength;
import hr.caellian.id3lib.object.ObjectStringNullTerminated;
...
public class FrameBodyGRID extends AbstractID3v2FrameBody {
    ...
    public FrameBodyGRID(final String owner, final byte groupSymbol, final byte[] data) {
        ...
        setObject("Group Symbol", groupSymbol);
    ...
    public void setGroupSymbol(final byte textEncoding) {
        setObject("Group Symbol", textEncoding);
    }

    public byte getGroupSymbol() {
        if (getObject("Group Symbol") != null) {
            return (Byte) getObject("Group Symbol");
        }
        return 0;
    }
