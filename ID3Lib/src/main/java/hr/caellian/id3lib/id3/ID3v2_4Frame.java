...
import hr.caellian.id3lib.lyrics3.FieldBodyAUT;
import hr.caellian.id3lib.lyrics3.FieldBodyEAL;
import hr.caellian.id3lib.lyrics3.FieldBodyEAR;
import hr.caellian.id3lib.lyrics3.FieldBodyETT;
import hr.caellian.id3lib.lyrics3.FieldBodyINF;
import hr.caellian.id3lib.lyrics3.FieldBodyLYR;
import hr.caellian.id3lib.lyrics3.Lyrics3v2Field;
import hr.caellian.id3lib.object.ObjectLyrics3Line;
...
//            this.setBody((AbstractID3v2FrameBody) TagUtility.copyObject(frame.getBody()));
    ...
    public boolean equals(final Object obj) {
        ...
        return this.dataLengthIndicator == id3v2_4Frame.dataLengthIndicator && super.equals(obj);
    }
    ...
    public void read(final RandomAccessFile file) throws IOException, InvalidTagException {
        ...
        do {
            ...
            b = file.readByte();
            hr.caellian.id3lib.id3.AbstractID3v2.incrementPaddingCounter();
        } while (b == 0);
        file.seek(filePointer);
        hr.caellian.id3lib.id3.AbstractID3v2.decrementPaddingCounter();
