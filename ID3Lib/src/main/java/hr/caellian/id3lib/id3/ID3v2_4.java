...
public class ID3v2_4 extends ID3v2_3 {
            ...
            if (mp3tag instanceof AbstractID3v2) {
                ...
                if (id3tag.genre >= 0) {
                    final String genre = "(" +
                                         ...
                                         ") " +
                                         TagConstant.genreIdToString.get((long) id3tag.genre);
    ...
    public boolean equals(final Object obj) {
        ...
        return this.updateTag == id3v2_4.updateTag && super.equals(obj);
    }
    ...
    private void copyFromID3v2Tag(final AbstractID3v2 mp3tag) {
        ...
        final Iterator iterator = mp3tag.getFrameIterator();
        AbstractID3v2Frame frame;
        ID3v2_4Frame newFrame;
        while (iterator.hasNext()) {
            frame = (AbstractID3v2Frame) iterator.next();
