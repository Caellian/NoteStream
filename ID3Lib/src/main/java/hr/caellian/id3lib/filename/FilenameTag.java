...
import hr.caellian.id3lib.TagUtility;
import hr.caellian.id3lib.id3.AbstractID3v2Frame;
import hr.caellian.id3lib.id3.FrameBodyCOMM;
import hr.caellian.id3lib.id3.FrameBodySYLT;
import hr.caellian.id3lib.id3.FrameBodyTALB;
import hr.caellian.id3lib.id3.FrameBodyTCOM;
import hr.caellian.id3lib.id3.FrameBodyTCON;
import hr.caellian.id3lib.id3.FrameBodyTDRC;
import hr.caellian.id3lib.id3.FrameBodyTIT2;
import hr.caellian.id3lib.id3.FrameBodyTPE1;
import hr.caellian.id3lib.id3.FrameBodyTRCK;
import hr.caellian.id3lib.id3.FrameBodyUSLT;
import hr.caellian.id3lib.id3.ID3v2_3Frame;
...
public class FilenameTag extends AbstractMP3Tag {
    ...
    public Iterator<AbstractID3v2Frame> getFrameOfType(final String identifier) {
    ...
    public void append(final AbstractMP3Tag abstractMP3Tag) {
        //todo Implement this hr.caellian.id3lib.AbstractMP3Tag abstract method
    ...
    public boolean hasFrame(final String identifier) {
        return id3tag != null && id3tag.hasFrame(identifier);
    }

    public boolean hasFrameOfType(final String identifier) {
        return id3tag != null && id3tag.hasFrameOfType(identifier);
    }
