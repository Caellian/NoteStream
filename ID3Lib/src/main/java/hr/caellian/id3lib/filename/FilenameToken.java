...
import hr.caellian.id3lib.id3.AbstractFrameBodyTextInformation;
import hr.caellian.id3lib.id3.AbstractFrameBodyUrlLink;
import hr.caellian.id3lib.id3.AbstractID3v2Frame;
import hr.caellian.id3lib.id3.AbstractID3v2FrameBody;
            ...
            if (TagOptionSingleton.getInstance().isCompositeMatchOverwrite() || id3v2FrameBodyClass == null) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (matchString.equals(lowerCaseToken) ||
                            matchString.contains(lowerCaseToken) ||
                            lowerCaseToken.contains(matchString)) {
        ...
        if (TagOptionSingleton.getInstance().isCompositeMatchOverwrite() || id3v2FrameBodyClass == null) {
            ...
            while (iterator.hasNext()) {
                ...
                if (lowerCaseToken.equals(matchString) ||
                    matchString != null &&
                    (matchString.contains(lowerCaseToken) || lowerCaseToken.contains(matchString))) {
