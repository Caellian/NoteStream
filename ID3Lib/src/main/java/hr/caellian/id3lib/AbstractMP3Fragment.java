...
public abstract class AbstractMP3Fragment extends AbstractMP3FileItem {
    ...
    public boolean isSubsetOf(final Object object) {
        ...
        if (object == null) {
            ...
            subsetOf = localBody == null && superSetBody == null ||
                    localBody != null && superSetBody != null && localBody.isSubsetOf(superSetBody) && super.isSubsetOf(object);
        }
        return subsetOf;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (obj instanceof AbstractMP3Fragment) {
            ...
            if (thisIdentifier.equals(equalsIdentifier)) {
                ...
                equals = thisBody.equals(equalsBody) && super.equals(obj);
            } else {
                equals = false;
            }
        } else {
